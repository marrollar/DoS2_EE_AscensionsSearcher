# --------------------------------------------------------------------------------------------------------------------------
# Courtesy of Pip. Taken from https://github.com/PinewoodPip/ee2buildplanner/blob/master/public/Scripts/Icons/icon_ripper.py
# --------------------------------------------------------------------------------------------------------------------------
...
from constants import AMER_ICONS_IMGS
